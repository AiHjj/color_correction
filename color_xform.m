function [cal_img, a, fit] = color_xform(orig_img, orig_top, orig_left, orig_bot, orig_right, ...
                                                                 orig_patch_info, ...
                                                                 proc_img, proc_top, proc_left, proc_bot, proc_right, ...
                                                                 robust, nonlinear)
% function [cal_img, a, fit] = color_xform(orig_img, orig_top, orig_left, orig_bot, orig_right, ...
...
figure(4); hold on
plot(proc_mean(:,1), orig_mean(:,1),'r.','markersize', 15); grid on
set(gca,'LineWidth',1)
...
figure(5);hold on
plot(proc_mean(:,2), orig_mean(:,2),'g.', 'markersize', 15);grid on
set(gca,'LineWidth',1)
set(gca,'FontName','Ariel')
set(gca,'fontsize',12)
...
figure(6);hold on
plot(proc_mean(:,3), orig_mean(:,3),'b.', 'markersize', 15);grid on
set(gca,'LineWidth',1)
set(gca,'FontName','Ariel')
set(gca,'fontsize',12)
...
if (nonlinear == -1)
    ...
    % Plot results and store figures.
    figure(10);  hold on
    plot(proc_mean(:,1),proc_mean_nlin(:,1),'.r', 'markersize', 15);grid on
    set(gca,'LineWidth',1)
    set(gca,'FontName','Ariel')
    set(gca,'fontsize',12)
    ...
    figure(11);hold on
    plot(proc_mean(:,2),proc_mean_nlin(:,2),'.g', 'markersize', 15);grid on
    set(gca,'LineWidth',1)
    set(gca,'FontName','Ariel')
    set(gca,'fontsize',12)
    ...
    figure(12); hold on
    plot(proc_mean(:,3),proc_mean_nlin(:,3),'.b', 'markersize', 15); grid on
    set(gca,'LineWidth',1)
    set(gca,'FontName','Ariel')
    set(gca,'fontsize',12)
